...
{
    public const int Characteristic = 2;
    public const int Order = 256;
    public const int Primitive = 0x011D;

    private static ReadOnlySpan<byte> ExpTable => [
    ...
    public static (int[], int[]) GenerateLogsAndExponents()
    {
        var logTable = new int[Order];
        var expTable = new int[Order * 2];

        //TODO: Maybe this needs to be unsigned
        var x = 1;
